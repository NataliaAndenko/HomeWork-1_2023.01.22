...
double Distance(double x1, double x2, double y1, double y2, double z1, double z2)// дабл - десятичное число
{
    double a; double b; double c;
    a = x2 - x1;
    b = y2 - y1;
    c = z2 - z1;
    return Math.Sqrt(a * a + b * b + c * c);//вывод из куба Math.Sqrt(a * a * a)
}
